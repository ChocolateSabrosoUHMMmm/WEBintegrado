...
<script type="text/javascript" src="js/carrusel.js"></script>
  ...
  <body>
    ...
    .logoletra img {
      ...
      <a href="index.jsp" class="logoletra">
    <img src="img/logoweb.png" alt="Logo">
      ...
      <nav class="nav" id="nav">
        <button class="cerrar-menu" id="cerrar"> cerrar </button>
          <ul class="nav-list">
            <li><a class="barra" href="descubre.jsp">Categorias </a></li>
            <li><a class="barra"  href="vertodo.jsp"> ver todo</a></li>
            <li><a class="barra"  href="descubre.jsp"> sale</a></li>
            <li><a class="barra"  href=""> Nosotros</a></li>
           
            <li>
              <a href="iniciar.jsp" target="_blank" class="boton-iniciar">
                iniciar sesion
              </a> 
            </li>
            <li>
              <a href="registrarse.jsp" target="_blank" class="boton-registrar">
                Registrate
              </a>
            </li>
...
<!-- portada -->
    <div class="banner">
      <video autoplay loop muted plays-inline>
          <source src="video/portadaweb.mp4" type="video/mp4">
      </video>
   
      <div class="content">
          <h1>EXPLORE THE WORLD</h1>
          <div>
            <a href="descubre.html" class="boton-shop">Explorar</a>
          </div>
      </div>
  </div>
  ...
  <!--box-slider--------------->
    ...
    <!--img-box---------->
    <div class="slide-img">
    <img alt="1" src="img/img01.jpeg">
    <!--overlayer---------->
    <div class="overlay">
    <!--buy-btn------>	
    <a href="#" class="buy-btn"> ver ahora</a>	
    </div>
    </div>
    <!--detail-box--------->
    ...
    <a href="#" class="price"><i class="fas fa-heart"></i></a>
      ...
      <div class = "product-collection-wrapper">
          ...
          <div class = "product-col-left flex">
              <div class = "product-col-content">
                  ...
                  <p class = "text-light">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Molestiae consequatur facilis eligendi quibusdam voluptatibus exercitationem autem.</p>
          ...
          <div class = "product-col-right">
              <div class = "product-col-r-top flex">
                  <div class = "product-col-content">
                      ...
                      <p class = "text-light">Lorem ipsum dolor sit, casacas jean</p>
                      <button type = "button" class = "btn-dark">Shop now</button>
                  </div>
              </div>
              ...
              <div class = "product-col-r-bottom">
                  ...
                  <div class = "flex">
                      <div class = "product-col-content">
                          ...
                          <p class = "text-light">Lorem jean</p>
                          <button type = "button" class = "btn-dark">Shop now</button>
                      </div>
                  </div>
                  <!-- right -->
                  <div class = "flex">
                      <div class = "product-col-content">
                          ...
                          <p class = "text-light">Lorem polo.</p>
                          <button type = "button" class = "btn-dark">Shop now</button>
                      </div>
                  </div>
              </div>
